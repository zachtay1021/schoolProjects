* For this assignment, we started working with objects and classes. I built a simple class called TimeType that works as a static clock. The user is able to set the hour, minute,
